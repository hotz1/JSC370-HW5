...
industry_baby <- '<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/5Z9KJZvQzH6PFmb8SNkxuk?utm_source=generator" width="100%" height="80" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe>'

popular_tracks <- cbind(popular_tracks, industry_baby)
popular_tracks <- popular_tracks %>%
  mutate(Link = stringr::str_replace(industry_baby, '5Z9KJZvQzH6PFmb8SNkxuk', Track_ID)) %>%
